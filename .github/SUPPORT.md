# Getting help with runjob

Thanks for using runjob. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/runjob/issues) to make sure the 
